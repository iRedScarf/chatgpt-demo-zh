...
export default () => {
  ...
  const maxHistoryMessages = parseInt(import.meta.env.MAX_HISTORY_MESSAGES || '2', 2)
  ...
  return (
    <div my-6>
      ...
      >
        <div class="gen-text-wrapper" class:op-50={systemRoleEditing()}>
          <textarea
            ...
            class="gen-textarea"
          />
          <button class="text-sm whitespace-nowrap" onClick={handleButtonClick} disabled={systemRoleEditing()} gen-slate-btn>
            发送
          </button>
          <button title="清空对话" onClick={clear} disabled={systemRoleEditing()} gen-slate-btn>
            <IconClear />
          </button>
        </div>
      </Show>
      <div class="fixed bottom-5 left-5 rounded-md hover:bg-slate/10 w-fit h-fit transition-colors active:scale-90" class:stick-btn-on={isStick()}>
        <div>
          <button class="p-2.5 text-base" title="滑至底部" type="button" onClick={() => setStick(!isStick())}>
